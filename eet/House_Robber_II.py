...
We do not want to throw it away. Then, it becomes how can we reduce this problem to 
the simpler one. Actually, extending from the logic that if house i is not robbed, 
...
Hence, the following solution. I chose i = n and i + 1 = 0 for simpler coding. 
